...
$rooms = "select room_id, room_number, room_type_name, room_cost, smoke_friendly, pet_friendly from rooms inner join room_type on rooms.rooms_type_id = room_type.room_type_id;";
    ...
    <div class="card">
            ...
            <div class="card-body">
              ...
              <table class="table table-hover datatable">
                ...
                <tbody>
                <?php
foreach ($connec->query($rooms) as $row) 
{
	?>
	<tr>
		<td> <?php print $row['room_id'] ?> </td>
		<td> <?php print $row['room_number'] ?> </td>		
		<td> <?php print $row['room_type_name'] ?> </td>
