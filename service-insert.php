...
{
    $query = "INSERT INTO hotel_services (service_id, service_name, service_description, service_cost) 
    VALUES ('$_POST[service_id]','$_POST[service_name]', '$_POST[desc]', '$_POST[service_cost]')";
    ...
    if (!$result_insert)
    {
      ...
      $_SESSION['insert_service_success'] = "Succesfully added $_POST[service_name]!";
        ...
        <div class="row">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" name="insert" action="service-insert.php" method="POST">
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" name="service_id" class="form-control" id="floatingName" placeholder="First Name" required>
                ...
                <div class="col-md-4">
                  <div class="form-floating">
                    <input type="text" name="service_name" class="form-control" id="floatingName" placeholder="First Name" required>
                    <label for="floatingName">Service Name</label>                    
                  </div>                                  
                </div>
                <div class="col-md-4">
                  <div class="form-floating">
                    <input type="text" name="service_cost" class="form-control" id="floatingName" placeholder="Last Name" required>
